...
export default defineNuxtConfig({
  ...
  routeRules: process.env.NODE_ENV === 'production' ? {
    '/admin/**': { proxy: { to: 'http://localhost:3000/admin/**' } },
    '/_next/**': { proxy: { to: 'http://localhost:3000/_next/**' } },
    '/_payload/**': { proxy: { to: 'http://localhost:3000/_payload/**' } },
    '/media/**': { proxy: { to: 'http://localhost:3000/media/**' } },
  } : {
    '/admin/**': { proxy: { to: 'http://localhost:3001/admin/**' } },
    '/_next/**': { proxy: { to: 'http://localhost:3001/_next/**' } },
    '/_payload/**': { proxy: { to: 'http://localhost:3001/_payload/**' } },
    '/media/**': { proxy: { to: 'http://localhost:3001/media/**' } },
  },
